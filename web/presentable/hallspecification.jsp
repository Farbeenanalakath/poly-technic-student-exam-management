...
<body id="top">
    <form id="form1" name="form1" method="post" action="halllogic.jsp">
...
<div class="wrapper col2">
  <p>&nbsp;</p>
  <table width="200" height="482" >
    <tr>
      <td width="28%" height="476"><span class="style2"></span></td>
      <td width="41%"><table width="81%" height="93" border="0" bordercolor="#663300" bgcolor="#362C20" >
        <tr>
          <td width="51%" height="46"><label> HALL NUMBER </label></td>
          <td width="49%"><label>
            <input name="txthallnumber" type="text" id="txthallnumber" />
          </label></td>
        </tr>
        <tr>
          <td height="35"><label>TOTAL STUDENTS </label></td>
          <td><label>
            <input name="txttotalstudents" type="text" id="txttotalstudents" />
          </label></td>
        </tr>
      </table>
        <label></label>
