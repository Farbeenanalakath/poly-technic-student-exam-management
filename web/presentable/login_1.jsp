...
<body id="top">
    <form id="form1" name="form1" method="post" action="successlogin.jsp">
...
<div class="wrapper col2">
  ...
  <table width="200" height="275" >
    <tr>
      ...
      <td width="41%"><table width="81%" height="444" border="0" bordercolor="#663300" bgcolor="#362C20" >
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><p class="style1">LOGIN HERE! </p>
            <p>&nbsp; </p></td>
        </tr>
        <tr>
          <td>USER NAME </td>
        ...
        <tr>
          ...
          <td width="63%">
            <label>
              <input name="txtpolyno" type="password" id="txtpolyno" />
              </label>              </td>
        </tr>
        <tr>
          <td height="32">&nbsp;</td>
          ...
          <td>
            <label>
              <input name="btnsSubmit" type="submit" id="btnsSubmit" value="LOGIN" />
            </label>
