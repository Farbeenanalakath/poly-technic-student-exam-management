...
%>
<%
ExternalHandler lh1=new ExternalHandler();
try
{
rsData=lh1.getid();
...
<div class="wrapper col2">
  ...
  <table width="92%" border="0">
    <tr>
      <td width="11%" height="34">External Name </td>
      <td width="14%">Institution Name </td>
      <td width="20%">Specialize</td>
      <td width="26%">Contact Number </td>
      <td width="29%">Email Id </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
