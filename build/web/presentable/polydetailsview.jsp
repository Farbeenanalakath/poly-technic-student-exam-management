  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="login_l.jsp">LogIn</a></li>
...
<div class="wrapper col2">
  ...
  <table width="95%" border="1">
    <tr>
      <td width="4%" height="65">T No </td>
      <td width="9%">Poly Number </td>
      <td width="9%">Poly Name </td>
      <td width="9%">Address</td>
      <td width="12%">Contact Number </td>
      <td width="10%">E mail ID </td>
      <td width="13%">Principal Name </td>
      <td width="12%">No Of Branches </td>
      <td width="11%">Total staff </td>
